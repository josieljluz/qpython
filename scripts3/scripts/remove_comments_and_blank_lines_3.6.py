...
def remove_unused_imports(file_path):
    try:
        ...
        result = subprocess.run(['which', 'autoflake'], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
...
# Caminho do arquivo
arquivo_entrada = "/storage/emulated/0/qpython/scripts3/arquivo.py"
arquivo_saida = "/storage/emulated/0/qpython/scripts3/arquivo_sem_comentarios.py"
