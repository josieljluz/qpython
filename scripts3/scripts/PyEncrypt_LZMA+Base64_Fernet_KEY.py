...
# Função para criptografar código
def criptografar_codigo(opcao, caminho_arquivo):
...
# Função para descriptografar código
def descriptografar_codigo(caminho_arquivo):
...
def menu():
    ...
    if opcao == "1" or opcao == "2":
        ...
        descriptografar_codigo(caminho_arquivo)
    elif opcao == "4":
        print("\nSaindo...\n")
        exit()
    else:
